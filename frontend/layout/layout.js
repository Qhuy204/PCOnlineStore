...
const Layout = (props) => {
    ...
    return (
        <React.Fragment>
            <Head>
                <title>GEARVN | Admin page</title>
                <meta charSet="UTF-8" />
                <meta name="description" content="GEARVN | Admin page" />
                <meta name="robots" content="index, follow" />
                <meta name="viewport" content="initial-scale=1, width=device-width" />
                <meta property="og:type" content="website"></meta>
                <meta property="og:title" content="GEARVN | Admin page"></meta>
                <meta property="og:url" content="http://localhost:3000/"></meta>
                <meta property="og:description" content="GEARVN | Admin page" />
                <meta property="og:image" content="/img_data/index/favicon.png"></meta>
                <meta property="og:ttl" content="604800"></meta>
                <link rel="icon" href={`/img_data/index/favicon.png`} type="image/x-icon"></link>
            </Head>
